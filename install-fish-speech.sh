...
# 4. Initialize and Install Fish Speech
print_info "Preparing and installing Fish Speech engine..."
mkdir -p "${DEPS_DIR}"
ensure_submodule "${FISH_SPEECH_DIR}"
cd "${FISH_SPEECH_DIR}"
pip install -e .
cd "${PROJECT_DIR}"
...
echo " "
echo "To start the Web UI server, run:"
echo "  conda activate ${CONDA_ENV_NAME}"
echo "  python server.py"
echo " "
echo "Or use the one-click startup script:"
echo "  ./run.sh"
echo " "
